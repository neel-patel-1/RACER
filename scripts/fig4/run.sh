...
#PAYLOAD_SIZES=( 256 1024 4096 16384 65536 262144 1048576 $(( 2 * 1024 * 1024 )) $(( 4 * 1024 * 1024 ))  $(( 8 * 1024 * 1024 )) $(( 16 * 1024 * 1024 )) $(( 32 * 1024 * 1024 )) $(( 64 * 1024 * 1024 )) $(( 128 * 1024 * 1024 )) $(( 256 * 1024 * 1024 )) $(( 512 * 1024 * 1024 )) $(( 1024 * 1024 * 1024 )) $(( 2 * 1024 * 1024 * 1024 )) $(( 4 * 1024 * 1024 * 1024 )) )
PAYLOAD_SIZES=( $(( 8 * 1024 * 1024 )) $(( 16 * 1024 * 1024 )) $(( 32 * 1024 * 1024 )) $(( 64 * 1024 * 1024 )) $(( 128 * 1024 * 1024 )) $(( 256 * 1024 * 1024 )) $(( 512 * 1024 * 1024 )) $(( 1024 * 1024 * 1024 )) $(( 2 * 1024 * 1024 * 1024 )) $(( 4 * 1024 * 1024 * 1024 )) )
